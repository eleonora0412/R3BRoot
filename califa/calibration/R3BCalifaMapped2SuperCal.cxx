...
// R3BCalifaMapped2SuperCal::Constructor
R3BCalifaMapped2SuperCal::R3BCalifaMapped2SuperCal()
    : FairTask("R3BCalifaMapped2SuperCal")
    , fNumCrystals(0)
    , fNumParams(0)
    , fNumTotParams(0)
    , fCalParams(NULL)
...
void R3BCalifaMapped2SuperCal::SetParameter()
{
...
InitStatus R3BCalifaMapped2SuperCal::Init()
{
    ...
    rootManager->Register("CalifaSuperCalData", "CALIFA Super Cal", fCalifaCryCalDataCA, !fOnline);
...
void R3BCalifaMapped2SuperCal::Exec(Option_t* option)
{
...
R3BCalifaCrystalCalData* R3BCalifaMapped2SuperCal::AddCalData(Int_t id,
                                                                Double_t energy,
                                                                Double_t Nf,
                                                                Double_t Ns,
                                                                uint64_t wrts,
